...
# test/evaluation/phases.jsonl. report.py asks Prometheus, per metric and per entity,
...
LOGDIR="$HERE/logs"
NS=default
# Overridable like PROM_URL below. Defaults to GHCR, which is where CI publishes
# (.github/workflows/*.yml); a local registry still works by exporting REGISTRY.
REGISTRY=${REGISTRY:-ghcr.io/loiht2}
